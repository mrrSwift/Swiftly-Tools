module.exports.sr = {
  fa: {
    ...
    response: {
      ...
      email_not_confirmed:
        "ابتدا ایمیل خود را تایید کنید،لینک فعال سازی قبلا برای شما فرستاده شده است.",
  ...
  en: {
    ...
    response: {
      ...
      email_not_confirmed:
        "Confirm your email first, the activation link has already been sent to you.",
  ...
  de: {
    required: {
      ...
      email_company:
        "Für juristische Personen ist eine Unternehmens-E-Mail erforderlich",
      company_name:
        "Geben Sie den Firmennamen ein, wenn Sie eine juristische Person sind",
    ...
    response: {
      ...
      email_not_confirmed:
        "Bestätigen Sie zuerst Ihre E-Mail, der Aktivierungslink wurde bereits an Sie gesendet.",
  ...
  tr: {
    ...
    response: {
      ...
      email_not_confirmed:
        "Önce e-postanızı onaylayın, aktivasyon bağlantısı size zaten gönderildi.",
  ...
  it: {
    required: {
      ...
      email_company:
        "L'email aziendale è obbligatoria per le persone giuridiche",
      company_name:
        "Inserisci il nome dell'azienda se sei una persona giuridica",
    ...
    response: {
      ...
      activation_email: "Activation email sent to you",
      expired_reset_link:
        "L'attuale link del passaggio di reimpostazione è scaduto",
      email_not_confirmed:
        "Conferma prima la tua email, il link di attivazione ti è già stato inviato.",
